...
void PRINT_GPU_ALLOC (void);
void PRINT_GPU_MEMORY (void);
void PERCENT (int *stat, int *Size);
int CUBLAS_SHUTDOWN (void);
int CUBLAS_ALLOC (const int *n, const int *elemSize, devptr_t *devicePtr);
int cublas_alloc_safety_(const int *n, const int *elemSize, devptr_t *devicePtr);
int CUBLAS_FREE (const devptr_t *devicePtr);
void MAX_GPU_MEMORY (void);
void GET_GPU_MAX_MEMORY(int *memory);
int cublas_set_vector_(const int *n, const int *elemSize, const void *x,
                       const int *incx, const devptr_t *y, const int *incy);
int CUBLAS_SET_VECTOR_SHZ (const int *n, const int *elemSize, const void *x,
                           const int *incx, const devptr_t *y, const int* shift, const int *incy);
int CUBLAS_GET_VECTOR (const int *n, const int *elemSize, const devptr_t *x,
                       const int *incx, void *y, const int *incy);
int CUBLAS_GET_VECTOR_ASYNC (const int *n, const int *elemSize, const devptr_t *x,
                             const int *incx, void *y, const int *incy);
int CUBLAS_GET_VECTOR_SHZ (const int *n, const int *elemSize, const devptr_t *x,const int * shift,
                           const int *incx, void *y, const int *incy);
int CUBLAS_SET_MATRIX (const int *rows, const int *cols, const int *elemSize,
                       const void *A, const int *lda, const devptr_t *B, 
                       const int *ldb);
int CUBLAS_SET_MATRIX_ASYNC (const int * StreamIdx, const int *rows, const int *cols, const int *elemSize,
                       const void *A, const int *lda, const devptr_t *B, 
                       const int *ldb);
...
void CUBLAS_DAXPY_C (const int *n, const double *alpha, const devptr_t *devPtrx, 
                   const int *incx, const devptr_t *devPtry, const int *incy);
...
void CUBLAS_ZGEMM_C (const char *transa, const char *transb, const int *m,
...
void CUBLAS_ZGEMMSH_C (const char *transa, const char *transb, const int *m,
                     const int *n, const int *k, const cuDoubleComplex *alpha,
 ...
 void CUBLAS_ZGEMMSH_SP (const char *transa, const char *transb, const int *m,
                     const int *n, const int *k, const cuDoubleComplex *alpha,
                     const devptr_t *devPtrA,const int *shiftA, const int *lda,
                     const devptr_t *devPtrB,const int *shiftB, const int *ldb,
                     const cuDoubleComplex *beta, 
...
void CUBLAS_ZGEMMSH_ST_C (const int * StreamIdx, const char *transa, const char *transb, const int *m,
                     const int *n, const int *k, const cuDoubleComplex *alpha,
                     const devptr_t *devPtrA,const int *shiftA, const int *lda,
                     const devptr_t *devPtrB,const int *shiftB, const int *ldb,
                     const cuDoubleComplex *beta, 
...
void CUBLAS_DGEMMSH_C (const char *transa, const char *transb, const int *m,
                     const int *n, const int *k, const double *alpha, 
                     const devptr_t *devPtrA,const int *shiftA, const int *lda,
                     const devptr_t *devPtrB,const int *shiftB, const int *ldb,
                     const double *beta,
...
void CUBLAS_DGEMMSH_ST_C (const int *StreamIdx,const char *transa, const char *transb, const int *m,
                     const int *n, const int *k, const double *alpha, 
                     const devptr_t *devPtrA,const int *shiftA, const int *lda,
                     const devptr_t *devPtrB,const int *shiftB, const int *ldb,
                     const double *beta,
...
void CUBLAS_ZGEMV_SHIFT (const char *trans, const int *m, const int *n,
                         const cuDoubleComplex *alpha, const devptr_t *A,const int *shiftA,
                         const int *lda, const devptr_t *x, const int *shiftx, const int *incx,
                         const cuDoubleComplex *beta, devptr_t *y, const int *shifty,
                         const int *incy);

void CUBLAS_ZDOTC_SHIFT (const int *n, const devptr_t *devPtrx, const int *shiftx,
                         const int *incx, const devptr_t *devPtry, const int *shifty,
                         const int *incy, cuDoubleComplex *retVal);

void CUBLAS_ZSCAL_SHIFT (const int *n, const double *alpha, const devptr_t *x, const int *shiftx,
                         const int *incx);
