...
ROOTOBJDIR ?= obj
LIBDIR     := lib
COMMONDIR  := $(CUDA_INSTALL_PATH)/samples/common
SHAREDDIR  := $(CUDA_INSTALL_PATH)/samples/common/
...
ifneq ($(findstring pgcc,$(CC)),pgcc)
    ...
    INCLUDES  += -I. -I$(COMMONDIR)/inc ####-I$(SHAREDDIR)/inc
endif
...
OBJS +=  $(patsubst %.c,$(OBJDIR)/%.c.o,$(patsubst %.cpp,$(OBJDIR)/%.cpp.o,$(notdir $(CFILES))))
...
$(OBJDIR)/%.cu.o : $(SRCDIR)%.cu $(CU_DEPS)
	$(VERBOSE)$(NVCC)  $(GENCODE_ARCH)  $(NVCCFLAGS) $(SMVERSIONFLAGS) -o $@ -c $<

# Default arch includes gencode for sm_10, sm_20, and other archs from GENCODE_ARCH declared in the makefile
$(CUBINDIR)/%.cubin : $(SRCDIR)%.cu cubindirectory
	$(VERBOSE)$(NVCC)  $(GENCODE_ARCH)  $(CUBIN_ARCH_FLAG) $(NVCCFLAGS) $(SMVERSIONFLAGS) -o $@ -cubin $<
